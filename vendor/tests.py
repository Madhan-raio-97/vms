...
class VendorPerformanceAPIViewTest(APITestCase):
    def setUp(self):
        ...
        self.token = Token.objects.create(user=self.user)
        self.client.credentials(HTTP_AUTHORIZATION='Token ' + self.token.key)
        self.vendor = Vendor.objects.create(name='KDS Technologies', contact_details='support@tdsrtech.com', vendor_code='VENDOR055', address="901 Cedar Avenue, Mountainview, USA")
